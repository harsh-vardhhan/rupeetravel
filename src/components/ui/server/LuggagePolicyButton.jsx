...
export default function LuggagePolicyButton({ airline }) {
  ...
  let vietjetOption =
    vietjet &&
    policy.extraCheckedOptions.find(
      (opt) => opt.weightValue === selectedWeight,
    );
            ...
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-2 bg-blue-50 rounded-lg px-3 py-2">
                ...
                <div>
                  ...
                  <span className="font-mono">{policy.carryOn.weight}</span>{" "}
                  {policy.carryOn.free ? (
              ...
              <div className="flex items-center gap-2 bg-yellow-50 rounded-lg px-3 py-2">
                ...
                <div>
                  ...
                  <span className="font-mono">{policy.checked.weight}</span>{" "}
                  {policy.checked.free ? (
                    <span className="text-green-600 font-medium">(Free)</span>
                  ) : (
                    <span className="text-red-600 font-medium">(Paid)</span>
                  ...
                  <div className="mt-3 p-3 bg-white rounded-lg border border-orange-100">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="font-medium">
                        {vietjetOption.weight} checked baggage
                      </span>
                    </div>
                    <div className="flex flex-col gap-1 mt-1 text-sm">
                      <span>
                        💸{" "}
                        <span className="font-semibold">
                          ₹{vietjetOption.beforeThreeHours}
                        </span>{" "}
                        <span className="text-gray-500">
                          (booked &gt;3h before flight)
                        </span>
                      </span>
                      <span>
                        💸{" "}
                        <span className="font-semibold">
                          ₹{vietjetOption.afterThreeHours}
                        </span>{" "}
                        <span className="text-gray-500">
                          (booked &lt;3h before flight)
                        </span>
