        ...
        <div style={{ display: "flex", justifyContent: "center" }}>
          ...
          >
              ...
              <Table variant="simple">
                ...
                <Tbody>
                  ...
                  <Tr onClick={() => VNDNotesClick()}>
                    <Td>
                      <b>
                        <u>Vietnam currency notes in Indian Rupees</u>
                      </b>
                    </Td>
                  </Tr>
                </Tbody>
              ...
              <Text style={{ marginTop: "20px" }} fontSize="xl">
                ...
                <a href="#">
                  <b
                    onClick={() =>
                      window.open(
                        "https://www.rupeetravel.com/food-delivery-taxi-vietnam",
                      )
                    }
                  >
                    <u>{`Grab`}</u>
              ...
              <Text style={{ marginTop: "20px" }} fontSize="xl">
                ...
                <a href="#">
                  <b
                    onClick={() =>
                      window.open(
                        "https://www.rupeetravel.com/e-visa-vietnam-indians",
                      )
                    }
                  >
              ...
              <Text style={{ marginTop: "20px" }} fontSize="xl">
                ...
                <a href="#">
                  <b
                    onClick={() =>
                      window.open(
                        "https://inc42.com/buzz/neobank-niyo-users-bear-the-brunt-as-partner-sbm-bank-india-comes-under-rbi-radar/",
                      )
                    }
                  >
                    <u>{` Niyo`}</u>
            ...
            >
              <Heading
                fontSize={"lg"}
              >{` What to do with the unspent Vietnam currency?`}</Heading>
              <Text style={{ marginTop: "20px" }} fontSize="xl">
            ...
            <Heading ref={VNDNotesRef} style={{ marginTop: "20px" }}>
              {" "}
              Vietnam currency notes in Indian Rupees
            </Heading>
            <Text style={{ marginTop: "20px" }} fontSize="xl">
              Let's understand the physical currency notes in Vietnam and how
              much they value in Indian Rupees.
            </Text>
            <Image
            ...
            >
              <Text style={{ marginTop: "20px" }} fontSize="xl">
                ...
                Roughly the same amount ₫600,000 VND gets you an hotel room in
                Da Nang for a night.
              </Text>
              <Image
