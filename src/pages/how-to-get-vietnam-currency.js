        ...
        <>
            ...
            <Flex justify="center" flex={1}>
                ...
                >
                    ...
                    <Text style={{ marginTop: '20px' }} fontSize={{ base: "md", md: "lg", lg: "xl" }}>
                    ...
                    <Card
                        ...
                        w="100%"
                    >
                        <Heading fontSize={{ base: "xl", md: "2xl", lg: "3xl" }}>{` But why use cash in Vietnam and not credit or debit cards?`}</Heading>
                        <Text style={{ marginTop: '20px' }} fontSize={{ base: "md", md: "lg", lg: "xl" }}>
                    ...
                    <Card
                        ...
                        w="100%"
                    >
                        <Heading fontSize={{ base: "xl", md: "2xl", lg: "3xl" }}> Why is buying VND so expensive in India?</Heading>
                        <Text style={{ marginTop: '20px' }} fontSize={{ base: "md", md: "lg", lg: "xl" }}>
                    ...
                    <Card
                        ...
                        w="100%"
                    >
                        <Heading fontSize={{ base: "xl", md: "2xl", lg: "3xl" }}> Can I buy USD currency notes from BookMyForex whenever I want?</Heading>
                        <Text style={{ marginTop: '20px' }} fontSize={{ base: "md", md: "lg", lg: "xl" }}>
                    ...
                    <Card
                        ...
                        w="100%"
                    >
                        <Heading fontSize={{ base: "xl", md: "2xl", lg: "3xl" }}>{` Are online forex brokers like BookMyForex always giving better rates than brick-and-mortar ones?`}</Heading>
                        <Text style={{ marginTop: '20px' }} fontSize={{ base: "md", md: "lg", lg: "xl" }}>
                    ...
                    <Card
                        ...
                        w="100%"
                    >
                        <Heading fontSize={{ base: "xl", md: "2xl", lg: "3xl" }}>{` What if I didn't spend all the USD I purchased for my Vietnam travel?`}</Heading>
                        <Text style={{ marginTop: '20px' }} fontSize={{ base: "md", md: "lg", lg: "xl" }}>
                    ...
                    <Card
                        ...
                        w="100%"
                    >
                        <Heading fontSize={{ base: "xl", md: "2xl", lg: "3xl" }}>{` How much foreign currency can I carry from India?`}</Heading>
                        <Text style={{ marginTop: '20px' }} fontSize={{ base: "md", md: "lg", lg: "xl" }}>
                    ...
                    <Card
                        ...
                        w="100%"
                    >
                        <Heading fontSize={{ base: "xl", md: "2xl", lg: "3xl" }}>{`So, if you have zero forex markup debit card, you don't need to carry USD currency notes?`}</Heading>
                        <Text style={{ marginTop: '20px' }} fontSize={{ base: "md", md: "lg", lg: "xl" }}>
                    ...
                    <Card
                        ...
                        w="100%"
                    >
                        <Heading fontSize={{ base: "xl", md: "2xl", lg: "3xl" }}>{`How to find zero forex markup ATMs for cash withdrawal in Vietnam?`}</Heading>
                        <Text style={{ marginTop: '20px' }} fontSize={{ base: "md", md: "lg", lg: "xl" }}>
                            {`You can search for `}
                    ...
                    <Card
                        ...
                        w="100%"
                    >
                        <Heading fontSize={{ base: "xl", md: "2xl", lg: "3xl" }}>{`Which debit cards are accepted in Vietnam ATMs for cash withdrawal?`}</Heading>
                        <Image
                    ...
                    <Card
                        ...
                        w="100%"
                    >
                        <Heading fontSize={{ base: "xl", md: "2xl", lg: "3xl" }}>{`What is forex card?`}</Heading>
                        <Text style={{ marginTop: '20px' }} fontSize={{ base: "md", md: "lg", lg: "xl" }}>
                    ...
                    <Card
                        ...
                        w="100%"
                    >
                        <Heading fontSize={{ base: "xl", md: "2xl", lg: "3xl" }}>{`Why is conversion rates for VND via Vietnam ATM's so great?`}</Heading>
                        <Text style={{ marginTop: '20px' }} fontSize={{ base: "md", md: "lg", lg: "xl" }}>
                    ...
                    <Card
                        ...
                        w="100%"
                    >
                        <Heading fontSize={{ base: "xl", md: "2xl", lg: "3xl" }}>{`Can you bring back the Vietnam currency to India?`}</Heading>
                        <Text style={{ marginTop: '20px' }} fontSize={{ base: "md", md: "lg", lg: "xl" }}>
                    ...
                    <Card
                        ...
                        w="100%"
                    >
                        <Heading fontSize={{ base: "xl", md: "2xl", lg: "3xl" }}>{`How to exchange foreign currency to Indian rupees?`}</Heading>
                        <Text style={{ marginTop: '20px' }} fontSize={{ base: "md", md: "lg", lg: "xl" }}>
