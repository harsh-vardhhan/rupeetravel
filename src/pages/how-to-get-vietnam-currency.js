      ...
      <main className={styles.main}>
        ...
        <div style={{ display: "flex", justifyContent: "center" }}>
          ...
          >
            ...
            <Text style={{ marginTop: "20px" }} fontSize="xl">
              <b>The dumb way:</b> You can buy VND in India from an authorised
              forex dealer like BookMyforex. But it can be seen that rate
              offered by BookMyForex is not great compared to the offering in
              the forex market.
            </Text>
            <Card
              style={{
