        ...
        <div style={{ display: "flex", justifyContent: "center" }}>
          ...
          >
            ...
            <Heading fontSize={"lg"} style={{ marginTop: "20px" }}>
              {" "}
              INRVND currency converter with forex rate:
            </Heading>
            ...
            <Text style={{ marginTop: "20px" }} fontSize="xl">
              You can buy VND in India from an authorised forex dealer like
              BookMyforex. But it can be seen that rate offered by BookMyForex
              is not great compared to the offering in the forex market.
            </Text>
          </div>
        </div>
      </main>
