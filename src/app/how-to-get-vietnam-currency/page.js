      ...
      <div className="min-h-screen bg-background">
        ...
        <main className="container max-w-2xl mx-auto px-4 sm:px-6 py-8 sm:py-12 mt-4">
          <div className="grid grid-cols-1 gap-4 sm:gap-6">
            ...
            <div>
              <h2 className="text-2xl font-bold mb-4" id="inr-vnd">
                INR to Vietnam currency
              </h2>
              <CurrencyConverter
                currencyPair={"INRVND"}
            ...
            <div>
              <h2 className="text-2xl font-bold mb-4" id="buy-vnd">
                Buy Vietnam currency in India
              </h2>
              <CurrencyConverter
                currencyPair={"INRVND"}
            ...
            <div>
              <h2 className="text-2xl font-bold mb-4" id="buy-usd">
                Buy USD in India
              </h2>
              <Image
            ...
            <div>
              ...
              <p className="text-lg mt-4">
                ...
                hubs like{" "}
                <Link
                  href="https://www.rupeetravel.com/da-nang-map"
                  className="font-bold text-blue-600 hover:underline"
                >
                  Da Nang
                </Link>
            ...
            <div>
              <h2 className="text-2xl font-bold mb-4" id="withdraw-vnd">
                Withdraw VND from Vietnam ATM
              </h2>
              <Image
            ...
            <div>
              <h2 className="text-2xl font-bold mb-4" id="vnd-notes">
                Vietnam currency in Indian Rupees
              </h2>
              <Table>
                <TableHeader>
            ...
            <Card className="w-full bg-orange-50 dark:bg-orange-900">
              <CardContent>
                ...
                <div className="mt-6 space-y-3">
                  ...
                  <p className="text-2xl">₫600,000/night</p>
                </div>
              </CardContent>
              <CardFooter>
                <Link
            ...
            <Card className="w-full bg-orange-50 dark:bg-orange-900">
              <CardContent>
                ...
                <div className="mt-6 space-y-3">
                  ...
                  <p className="text-2xl">₫220,000</p>
                </div>
              </CardContent>
              <CardFooter>
