                    ...
                    <div className="grid grid-cols-1 gap-4 sm:gap-6">
                                ...
                                <TableBody>
                                    <TableRow className="cursor-pointer hover:bg-muted/50">
                                        <TableCell className="font-medium">
                                            <Link href="#inr-vnd" className="underline">INR to Vietnam currency</Link>
                                        </TableCell>
                                    </TableRow>
                                    <TableRow className="cursor-pointer hover:bg-muted/50">
                                        <TableCell>
                                            <Badge variant="destructive" className="mb-2">Dumb way</Badge>
                                            <div className="mt-2">
                                    ...
                                    <TableRow className="cursor-pointer hover:bg-muted/50">
                                        <TableCell>
                                            <Badge variant="secondary" className="mb-2 bg-teal-100 text-teal-800">Smart way</Badge>
                                            <div className="mt-2">
                                    ...
                                    <TableRow className="cursor-pointer hover:bg-muted/50">
                                        <TableCell>
                                            <Badge variant="secondary" className="mb-2 bg-teal-100 text-teal-800">Smartest way</Badge>
                                            <div className="mt-2">
                                                <Link href="#withdraw-vnd" className="font-medium underline">
                                    ...
                                    <TableRow className="cursor-pointer hover:bg-muted/50">
                                        <TableCell className="font-medium">
                                            <Link href="#vnd-notes" className="underline">Vietnam currency in Indian Rupees</Link>
                                        </TableCell>
                                    </TableRow>
                                </TableBody>
                            </Table>
                        ...
                        <div>
                            ...
                            <p className="text-lg">
                                ...
                                {' '}
                                <Link href='https://www.rupeetravel.com/food-delivery-taxi-vietnam' className="font-bold text-blue-600 hover:underline">
                                    Grab bike
                                </Link>
                            </p>
                        </div>
                        ...
                        <Card className="w-full bg-orange-50 dark:bg-orange-900">
                            ...
                            <CardContent>
                                <p className="text-lg">
                                    ...
                                    {' '}
                                    <Link href='https://www.rupeetravel.com/e-visa-vietnam-indians' className="font-bold text-blue-600 hover:underline">
                                        Vietnam&apos;s e-visa
                                    </Link>
                        ...
                        <div>
                            ...
                            <p className="text-lg mt-4">
                                ...
                                You can carry the
                                {' '}
                                <Link href='https://www.rupeetravel.com/buy-foreign-currency-notes-online' className="font-bold text-blue-600 hover:underline">
                        ...
                        <div>
                            ...
                            <p className="text-lg mt-4">
                                ...
                                {' '}
                                <Link href='https://www.rupeetravel.com/atm-vietnam-zero-forex-markup' className="font-bold text-blue-600 hover:underline">
                        ...
                        <Card className="w-full bg-orange-50 dark:bg-orange-900">
                            ...
                            <CardContent>
                                <p className="text-lg">
                                    ...
                                    where banks like{' '}
                                    <Link href='https://inc42.com/buzz/neobank-niyo-users-bear-the-brunt-as-partner-sbm-bank-india-comes-under-rbi-radar/' className="font-bold text-blue-600 hover:underline">
                                        Niyo
                                    </Link>
                                    {' and '}
                                    <Link href='https://entrackr.com/2023/10/paytm-payments-bank-halts-intl-transactions-on-debit-cards/' className="font-bold text-blue-600 hover:underline">
                                        Paytm
                                    </Link>
                        ...
                        <Card className="w-full bg-red-50 dark:bg-red-900">
                            ...
                            <CardContent>
                                <p className="text-lg">
                                    ...
                                    {' or '}
                                    <Link href="https://www.google.com/maps?q=MB+Bank+ATM" className="font-bold text-blue-600 hover:underline">
                                        MB Bank
                                    </Link>.
                        ...
                        <Card className="w-full bg-orange-50 dark:bg-orange-900">
                            ...
                            <CardFooter>
                                <Link href="https://www.rupeetravel.com/hotel-booking-vietnam" className="w-full">
