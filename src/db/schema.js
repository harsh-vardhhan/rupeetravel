...
export const flight = sqliteTable('flight', {
  ...
  min_checked_luggage_price: integer('min_checked_luggage_price'),
  min_checked_luggage_weight: text('min_checked_luggage_weight'),
  total_with_min_luggage: integer('total_with_min_luggage'),
}); 